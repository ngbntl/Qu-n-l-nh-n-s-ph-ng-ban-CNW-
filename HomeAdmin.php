        ...
        <div class="body">
            <div class="left">
                <ul>
                    ...
                    <li index="4">Chèn nhân viên</li>
                    <li index="5">Chỉnh sửa phòng ban</li>
                    <li index="6">Xóa nhân viên</li>
    ...
    <script>
        ...
        function show(index) {
            ...
            if (index === 0) {
                ...
                contentEle.src = "ChenNv.php";
            } else if (index == 5) {
                contentEle.src = "ChinhSuaPhongBan.php";
            } else if (index == 6) {
                contentEle.src = "XoaNhanVien.php";
            }
